...
#define ADS1X15_MAIN_SEVERITY_FATAL				(ADS1X15_MAIN_VERBOSITY_QUIET)
#define ADS1X15_MAIN_SEVERITY_INFO				(ADS1X15_MAIN_VERBOSITY_NORMAL)
#define ADS1X15_MAIN_SEVERITY_DEBUG				(ADS1X15_MAIN_VERBOSITY_VERBOSE)
